...
return [
    ...
    */
    ...
    'model' => App\Models\User::class,   //ค่าเดิมคือ App\User::class, สำหรับ laravel ที่ต่ำกว่า v.8
    ...
    'identifiers' => [
        ...
        */
        ...
        'ldap' => [
            ...
            'locate_users_by' => 'samaccountname', //ค่าเเดิม userprincipalname
        ...
        'database' => [
            ...
            */
            ...
            'username_column' => 'username', //ค่าเดิม email
