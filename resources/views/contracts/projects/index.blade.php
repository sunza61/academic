...
<div class="row mb-3">
    ...
    <div class="col-sm-6 text-right mt-4">
        <a href="{{ route('contracts.projects.create', ['type_id' => $projectType->id]) }}" class="btn btn-primary shadow-sm">
...
<script>
    window.ROUTES = {
        cancelProjectBaseUrl: "{{ url('contracts/projects') }}",
        csrfToken: "{{ csrf_token() }}"
    };
</script>

<script src="{{ asset('js/contracts/projects/index.js?v=' . time()) }}"></script>
@endsection