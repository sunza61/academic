                ...
                @else
                    ...
                    @if (auth()->user()->hasAnyRole(['admin', 'staff', 'user', 'finance', 'plan', 'manager']))
                        <li class="nav-item dropdown">
                            <a id="projectDropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"
                                class="nav-link dropdown-toggle {{ request()->is(['projects/*', 'trainings/*', 'trainings2/*']) || request()->routeIs('admin.approvals.*') ? 'active' : '' }}">
                                จัดการโครงการ
                            ...
                            <ul aria-labelledby="projectDropdown" class="dropdown-menu border-0 shadow">
                                ...
                                <li><a href="{{ route('projects.select-type') }}"
                                        class="dropdown-item {{ request()->is(['projects/*', 'trainings/*']) ? 'active' : '' }}">จัดโครงการ/รับงานบริการวิชาการ</a>
                                </li>

                                @if (auth()->user()->hasAnyRole(['admin', 'staff', 'user', 'manager']))
                                    <li><a href="{{ route('trainings.projects.index') }}"
                                            class="dropdown-item {{ request()->is('trainings2/*') ? 'active' : '' }}">เปิดให้บริการวิชาการ</a>
                                    </li>
                                    <li><a href="{{ route('deliveries.index') }}" class="dropdown-item">บันทึกรายงาน</a>
                                    </li>
                                @endif
                                ...
                                @if (auth()->user()->hasRole('admin'))
                                    ...
                                    <li>
                                        <a href="{{ route('admin.approvals.index') }}"
                                            class="dropdown-item {{ request()->routeIs('admin.approvals.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a id="reportDropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"
                            class="nav-link dropdown-toggle {{ request()->routeIs(['reports.index', 'finance.dashboard', 'plan.dashboard']) ? 'active' : '' }}">
                            ติดตาม & รายงาน
                        </a>
                        <ul aria-labelledby="reportDropdown" class="dropdown-menu border-0 shadow">
                            ...
                            <li><a href="{{ route('reports.index') }}"
                                    class="dropdown-item {{ request()->routeIs('reports.index') ? 'active' : '' }}">รายงาน</a>
                            </li>

                            @if (auth()->user()->hasRole('finance') || auth()->user()->hasRole('admin'))
                                <li class="dropdown-divider"></li>
                                <li><a href="{{ route('finance.dashboard') }}"
                                        class="dropdown-item {{ request()->routeIs('finance.dashboard') ? 'active' : '' }}">ตรวจสอบงบประมาณ</a>
                                </li>
                            @endif

                            @if (auth()->user()->hasRole('plan') || auth()->user()->hasRole('admin'))
                                <li><a href="{{ route('plan.dashboard') }}"
                                        class="dropdown-item {{ request()->routeIs('plan.dashboard') ? 'active' : '' }}">ตรวจสอบแผนงาน</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                    ...
                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('staff'))
                        <li class="nav-item dropdown">
                            <a id="masterDataDropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"
                                class="nav-link dropdown-toggle {{ request()->is('master-data/*') ? 'active' : '' }}">
                                ข้อมูลพื้นฐาน
                            </a>
                            <ul aria-labelledby="masterDataDropdown" class="dropdown-menu border-0 shadow">
                                <li><a href="{{ route('master-data.project-types.index') }}"
                                        class="dropdown-item {{ request()->routeIs('master-data.project-types.*') ? 'active' : '' }}">ข้อมูลประเภทโครงการ</a>
                                </li>
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle font-weight-bold text-white" href="#"
