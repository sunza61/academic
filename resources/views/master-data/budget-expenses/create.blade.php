...
<div class="row mb-2">
    <div class="col-sm-6">
        <h3 class="m-0">เพิ่มข้อมูลหมวดหมู่รายจ่าย</h3>
    </div>
    <div class="col-sm-6 text-right">
        <a href="{{ route('master-data.budget-expenses.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> ย้อนกลับ</a>
    </div>
</div>

<div class="card shadow-sm border-0 mt-3">
    <form action="{{ route('master-data.budget-expenses.store') }}" method="POST">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <button class="btn btn-outline-primary" type="button" data-toggle="modal" data-target="#modalNewMain"><i class="fas fa-plus"></i> เพิ่มใหม่</button>
                        </div>
                    </div>
                </div>
...
@section('script')
    ...
    <script src="{{ asset('js/master-data/budget-expenses/create.js?v=' . time()) }}"></script>
@endsection