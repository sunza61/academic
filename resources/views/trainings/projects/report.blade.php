...
<div class="row mb-3 mt-2">
    ...
    <div class="col-sm-4 text-right">
        <a href="{{ route('trainings.projects.index', ['type_id' => $project->project_type_id]) }}" class="btn btn-secondary shadow-sm">
...
<form action="{{ route('trainings.projects.save-report', $project->id) }}" method="POST" id="form-report">
    @csrf
    ...
    <div class="card shadow-sm border-0 mb-4 project-section">
        ...
        <div class="card-footer bg-white text-right py-4 border-top">
            <a href="{{ route('trainings.projects.index', ['type_id' => $project->project_type_id]) }}" class="btn btn-secondary btn-lg shadow-sm mr-2">
...
@section('script')
<script src="{{ asset('js/trainings/projects/report.js?v=' . time()) }}"></script>
@endsection